...
#define MAXDELAY_SYSTICK        400000 // runs of delay function to prevent hang on the procedures 
...
inline uint8_t WaitWhileSysTick(uint32_t CounterLimit){ // if we need to waiting awhile SysTick content
  static uint32_t Counter = 1;
